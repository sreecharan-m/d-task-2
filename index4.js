      ...
      if(state.current == 1){
        ...
        for(let i=0;i < this.position.length; i++)
        {
           ...
           // let k=Math.floor(Math.random()*(3)) +1 ;
            ...
            switch(p.s)
            {
                case 1:shape1(p.x,p.y,p.r);
                       //obstacle.rotation_angle1++;
                       break;

                case 2:shape2(p.x,p.y,p.r);
                       //obstacle.rotation_angle2++;
                       break;
                       
                case 3:shape3(p.x,p.y,p.r);
...
function shape1(x,y,r){
         ...
         //console.log("hi");
         if(obstacle.rotation_angle1 === 90){

            obstacle.rotation_angle1=0;
            obstacle.col.unshift(obstacle.col.pop());
         }


         for(let i=0;i<4;i++){
            var a = i*(Math.PI/2)+ (obstacle.rotation_angle1 * Math.PI /180);
            ctx.strokeStyle = obstacle.col[i];
            //ctx.strokeStyle = "#3ff";
            ctx.beginPath();
            ctx.lineWidth=13;
...
function shape2(x,y,r){
           ...
           /*if(obstacle.rotation_angle2 === 90){
            ...
            for(let i=0;i<3;i++)
            {
                ...
                var a =(2*i*Math.PI/3) + (obstacle.rotation_angle2 * Math.PI /180);
                ctx.beginPath();
                ctx.strokeStyle=obstacle.col2[i];
                ctx.lineWidth=13;
...
function shape3(x,y,r){
            ...
            {
                //console.log("inside loop");
                var a =(i*Math.PI/2) + (obstacle.rotation_angle2 * Math.PI /180);
                ctx.beginPath();
                ctx.strokeStyle=obstacle.col2[i];
                ctx.lineWidth=13;
                ctx.moveTo( x + r*Math.cos(a) , y+r*Math.sin(a));
